  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      echo "<li class='nav-item p-2'>
        ...
        <li class="nav-item p-2">
          <a class="nav-link" href="#">Total price: <sup> <?php
           total_cart_price();?>/-</sup></a>
        </li>
</ul>
...
<div class="row px-1">
  <div class="col-md-10">
   ...
   <div class="row">
<!-- 
   //fetch th product from the database -->
    <?php
    // now we are fetching the product from our database with the help of the this query in an random order rand().
   get_all_products();
...
<div class="col-md-2 bg-secondary p-0">
  <ul class="navbar-nav me-auto">
    <li class="nav-item bg-info">
      <a href="#" class="nav-link text-dark text-center"><h5>Delivery Brands</h5></a>
</li>
<?php
get_brands();
?>
...
<ul class="navbar-nav me-auto"> 
    <li class="nav-item bg-info">
      <a href="#" class="nav-link text-dark text-center"><h5>category</h5></a>
</li>
<?php
get_categories();
